...
app.config(['$routeProvider', function($routeProvider) {
	$routeProvider.when('/candy', {
		templateUrl:'candy.htm'
		
	});
}]);

app.controller('homeController', function ($scope, $http, testService) {
$scope.rows = 3;
$scope.columns = 4;
$scope.page=0;
$scope.totalPages=0;
...
var response = $http({ method: 'GET', url:'http://localhost:8080/Icecream/icecreamList'});
